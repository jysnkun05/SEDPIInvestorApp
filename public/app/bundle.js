...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AccountStatement = __webpack_require__(159);

	var _AccountStatement2 = _interopRequireDefault(_AccountStatement);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	if (_typeof($("#account-statement").prop('tagName')) !== ( true ? 'undefined' : _typeof(undefined))) (0, _reactDom.render)(_react2.default.createElement(_AccountStatement2.default, null), document.getElementById('account-statement'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AccountStatement = function (_Component) {
		_inherits(AccountStatement, _Component);

		function AccountStatement(props) {
			_classCallCheck(this, AccountStatement);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AccountStatement).call(this, props));
			...
			value: function getAllTransactions(counter) {
				$.ajax({
					...
					error: function (xhr, status, error) {
						if (counter <= 3) this.getAllTransactions(counter + 1);else this.setState({ account: status });
					}.bind(this)
				});
			}
		}, {
						...
						rows = transactions.map(function (transaction, index) {
							...
							return _react2.default.createElement(
								...
								_react2.default.createElement(
									...
									!transaction.transaction_type.is_deduct ? transaction.amount : null
								),
								_react2.default.createElement(
									'td',
									{ className: 'text-right' },
	...
	exports.default = AccountStatement;
